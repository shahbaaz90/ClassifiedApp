...
namespace ClassifiedApp2.Droid.Services
{
    public class FacebookManager : Java.Lang.Object, IFacebookManager, IFacebookCallback, GraphRequest.IGraphJSONObjectCallback
    {
        ...
        public void Login(Action<FacebookUser, string> onLoginComplete)
        {
            ...
            LoginManager.Instance.LogInWithReadPermissions(Xamarin.Forms.Forms.Context as Activity, new List<string> { "public_profile", "email", "user_birthday", "user_location" });
        }
        ...
        public void OnSuccess(Java.Lang.Object result)
        {
            ...
            if (n != null)
            {
                ...
                bundle.PutString("fields", "id, first_name, email, last_name, picture.width(500).height(500), gender, birthday, location");
